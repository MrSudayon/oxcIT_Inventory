...
<?php
    $sqlSelectAll = "SELECT * FROM assets_tbl WHERE status!='Archive' AND assettype='Mobile'";
...
<div class="content">
    <main class="table" id="customers_table">
        <section class="table__header">
            <a href="../admin/add-assets.php?id=recordMobile" class="link-btn">New Record</a>
        ...
        <?php 
            if($rowCountPage != $rowCount) {
                ...
                if ($page > 1) {
                    echo '<a href="Mobile.php?page=' . ($page - 1) . '" class="next prev">Previous</a>';
                }
                ...
                for($i = $start_page; $i <= $end_page; $i++) {
                    ...
                    echo '<a href="Mobile.php?page=' . $i . '" class="next ' . $active_class . '">' . $i . '</a>';                  
                }  
                
                if ($page < $number_of_page) {
                    echo '<a href="Mobile.php?page=' . ($page + 1) . '" class="next">Next</a>';
                    echo '<a href="Mobile.php?page=all" class="next">All</a>';
                }
                echo '</div>';
