    ...
    <main class="table" id="customers_table">
        ...
        <?php 
            if($rowCountPage != $rowCount) {
                ...
                if ($page > 1) {
                    echo '<a href="Router.php?page=' . ($page - 1) . '" class="next prev">Previous</a>';
                }
                ...
                for($i = $start_page; $i <= $end_page; $i++) {
                    ...
                    echo '<a href="Router.php?page=' . $i . '" class="next ' . $active_class . '">' . $i . '</a>';                  
                }  
                
                if ($page < $number_of_page) {
                    echo '<a href="Router.php?page=' . ($page + 1) . '" class="next">Next</a>';
                    echo '<a href="Router.php?page=all" class="next">All</a>';
                }
                echo '</div>';
